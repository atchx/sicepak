...
@section('container')
    <div class="content-wrapper">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Edit Data Ranperda Tentang Perubahan APBD Dan Ranperkada Tentang Penjabaran Perubahan APBD</h4>
                <form class="forms-sample" method="post" action="/papbs/{{ $surat->id }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
